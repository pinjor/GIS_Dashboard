...
/// @nodoc
mixin _$MapCoordGeojsonResponse {
...
/// Create a copy of MapCoordGeojsonResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MapCoordGeojsonResponseCopyWith<MapCoordGeojsonResponse> get copyWith => _$MapCoordGeojsonResponseCopyWithImpl<MapCoordGeojsonResponse>(this as MapCoordGeojsonResponse, _$identity);

  /// Serializes this MapCoordGeojsonResponse to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MapCoordGeojsonResponse&&(identical(other.type, type) || other.type == type)&&(identical(other.info, info) || other.info == info)&&const DeepCollectionEquality().equals(other.features, features));
}
...
@override
String toString() {
  return 'MapCoordGeojsonResponse(type: $type, info: $info, features: $features)';
}
...
/// @nodoc
abstract mixin class $MapCoordGeojsonResponseCopyWith<$Res>  {
  factory $MapCoordGeojsonResponseCopyWith(MapCoordGeojsonResponse value, $Res Function(MapCoordGeojsonResponse) _then) = _$MapCoordGeojsonResponseCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MapCoordGeojsonResponseCopyWithImpl<$Res>
    implements $MapCoordGeojsonResponseCopyWith<$Res> {
  _$MapCoordGeojsonResponseCopyWithImpl(this._self, this._then);

  final MapCoordGeojsonResponse _self;
  final $Res Function(MapCoordGeojsonResponse) _then;
...
/// Adds pattern-matching-related methods to [MapCoordGeojsonResponse].
extension MapCoordGeojsonResponsePatterns on MapCoordGeojsonResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MapCoordGeojsonResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MapCoordGeojsonResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MapCoordGeojsonResponse value)  $default,){
final _that = this;
switch (_that) {
case _MapCoordGeojsonResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MapCoordGeojsonResponse value)?  $default,){
final _that = this;
switch (_that) {
case _MapCoordGeojsonResponse() when $default != null:
return $default(_that);case _:
...
class _MapCoordGeojsonResponse implements MapCoordGeojsonResponse {
  const _MapCoordGeojsonResponse({@JsonKey(name: 'type') this.type, @JsonKey(name: 'info') this.info, @JsonKey(name: 'features') final  List<GeoJsonFeature>? features}): _features = features;
  factory _MapCoordGeojsonResponse.fromJson(Map<String, dynamic> json) => _$MapCoordGeojsonResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$MapCoordGeojsonResponseCopyWith<_MapCoordGeojsonResponse> get copyWith => __$MapCoordGeojsonResponseCopyWithImpl<_MapCoordGeojsonResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MapCoordGeojsonResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MapCoordGeojsonResponse&&(identical(other.type, type) || other.type == type)&&(identical(other.info, info) || other.info == info)&&const DeepCollectionEquality().equals(other._features, _features));
}
...
/// @nodoc
abstract mixin class _$MapCoordGeojsonResponseCopyWith<$Res> implements $MapCoordGeojsonResponseCopyWith<$Res> {
  factory _$MapCoordGeojsonResponseCopyWith(_MapCoordGeojsonResponse value, $Res Function(_MapCoordGeojsonResponse) _then) = __$MapCoordGeojsonResponseCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'type') String? type,@JsonKey(name: 'info') GeoJsonInfo? info,@JsonKey(name: 'features') List<GeoJsonFeature>? features
});
...
/// @nodoc
class __$MapCoordGeojsonResponseCopyWithImpl<$Res>
    implements _$MapCoordGeojsonResponseCopyWith<$Res> {
  __$MapCoordGeojsonResponseCopyWithImpl(this._self, this._then);

  final _MapCoordGeojsonResponse _self;
  final $Res Function(_MapCoordGeojsonResponse) _then;

/// Create a copy of MapCoordGeojsonResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = freezed,Object? info = freezed,Object? features = freezed,}) {
  return _then(_MapCoordGeojsonResponse(
type: freezed == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String?,info: freezed == info ? _self.info : info // ignore: cast_nullable_to_non_nullable
