...
class VaccinePerformanceGraphWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    logg.i(
      '📊 GRAPH WIDGET: Looking for vaccine "${filterState.selectedVaccine}"',
    );
    logg.i(
      '📊 GRAPH WIDGET: Available vaccines from API (${vaccines.length}):',
    );
    ...
    logg.i(
      '📊 GRAPH WIDGET: Selected vaccine = "${selectedVaccine?.vaccineName}" (match: ${selectedVaccine?.vaccineName == filterState.selectedVaccine})',
    );
